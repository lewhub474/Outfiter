...
//    private let removeBGService = RemoveBGService()
//
//    
...
//                
//                //MARK: AQUI
////                ClothingImageSection(selectedImage: selectedImage, name: $name)
//                ClothingImageSection(selectedImage: processedImage, name: $name)
//
//
////                HStack{
////                    Spacer()
...
//
//                Button(action: {
//                    viewModel.addClothingWithImage(
//                        name: name,
//                        categoryId: selectedCategory,
//                        colorId: selectedColor,
//                        image: processedImage // usa la imagen sin fondo
//                    ) {
...
//
//
//private struct ClothingImageSection: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                // 🟠 Progress mientras se procesa la imagen
                if isProcessing {
                    ProgressView("Procesando imagen...")
                        .padding()
                        .foregroundColor(.white)
                ...
                // Imagen seleccionada con fondo removido (si existe)
                ClothingImageSection(selectedImage: processedImage ?? selectedImage, name: $name)
